    ...
    <>
      {isVisible && (
        <div id="alert-1" className="flex items-center p-4 mb-4  bg-black dark:bg-gray-800 dark:text-blue-400 absolute mx-auto top-4 left-1/2 transform -translate-x-1/2 min-h-36 px-8 py-3 mt-12 bg-opacity-70 rounded-lg text-white border-2 border-white" role="alert">
            ...
            <div className="ms-2 text-lg font-medium">
                Click any marker to learn more. &nbsp;&nbsp;&nbsp;&nbsp;
            </div>
                <button type="button" onClick={handleDismiss} className="ms-auto -mx-1.5 -my-1.5 bg-blue-50 text-blue-500 rounded-lg focus:ring-2 focus:ring-blue-400 p-1.5 hover:bg-blue-200 inline-flex items-center justify-center h-6 w-6 dark:bg-gray-800 dark:text-blue-400 dark:hover:bg-gray-700" data-dismiss-target="#alert-1" aria-label="Close">
